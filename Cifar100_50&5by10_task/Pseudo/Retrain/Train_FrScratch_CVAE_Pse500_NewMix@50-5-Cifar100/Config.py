...
code_root = "./Train_with_CVAE_Mixture_50_5"
...
class Config():
    ...
    def __init__(self):
        ...
        self.icl_epoch = 100
        self.icl_lr_dict = {"base":1e-3, "ss":1e-4}
        ...
        self.icl_cnn_lr_dict = {"base":1e-3, "ss":5e-4}  
