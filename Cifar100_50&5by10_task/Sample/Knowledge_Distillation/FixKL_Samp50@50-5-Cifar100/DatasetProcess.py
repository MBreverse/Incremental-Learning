...
from ModelCollection import Resnet50_FeatureExtrator, FeatureExtractor
from Config import *
...
if __name__ == "__main__":
    ...
    print(__name__)
    # cfg = Config()
    # Cifar_Split_Transform(base_classes = 50 , increm_classes = 5, total_classes = 100, data_root = './data')
    # Cifar_Split_Transform_Feature(base_classes = 50 , increm_classes = 5, total_classes = 100, data_root = './data', branch = '/50_5by10'):
