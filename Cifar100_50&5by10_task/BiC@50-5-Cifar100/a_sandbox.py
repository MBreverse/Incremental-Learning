...
# for i in range(11):
    # x.append(i+1)
# Write_Excel_From(title = ' ', values = x, wb_name = 'test_record.xlsx' , sh_name = 'ss_cnn_task_test',  mode = 'h')
# Write_Excel_From(title = ' ', values = x, wb_name = 'test_record.xlsx' , sh_name = 'ss_cnn_task_test',  mode = 'v')

# x = []
# for i in range(11):
    # x.append(i+1)
    # Write_Excel_From(title = None, values = x, wb_name = 'test_record.xlsx' , sh_name = 'ss_cnn_task_test',  mode = 'v', row = 2, col = i+2)   
