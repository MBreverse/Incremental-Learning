...
class Config():
    ...
    def __init__(self):
        ...
        self.icl_loss_ratio = [ 0.5, 0.5, 0.33, 0.25, 0.2, 0.16, 0.14, 0.125, 0.111] # 10/10 fixKD
        # self.icl_loss_ratio = [ 0.4, 0.22, 0.15, 0.1, 0.1, 0.09, 0.075, 0.061, 0.05] # 10/10 freeKD
