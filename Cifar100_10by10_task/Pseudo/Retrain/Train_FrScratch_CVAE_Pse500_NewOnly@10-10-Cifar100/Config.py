...
code_root = "./Train_FrScratch_CVAE_Pse500_NewOnly@10-10-Cifar100"
...
class Config():
    ...
    def __init__(self):
        ...
        # CVAE
        self.icl_cvae_lr = 1e-4
        self.icl_cvae_epochs = 30      

        self.base_epoch = self.base_cnn_epochs
        self.base_lr =  self.base_cnn_lr

        self.icl_epoch = self.icl_cnn_epoch
        self.icl_lr_dict = self.icl_cnn_lr_dict

        # self.icl_loss_ratio = [0.1, 0.09, 0.08, 0.077, 0.071, 0.066, 0.0625, 0.058, 0.055, 0.05]
        self.num_exemplar = 500
        self.batch_size = 512
